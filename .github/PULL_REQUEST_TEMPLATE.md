...
- [ ] Fase 0 — Kickoff
- [ ] Fase 1 — Diagnóstico baseline
- [ ] Fase 2 — Engenharia de citação
- [ ] Fase 3 — Execução de conteúdo HBR-grade
- [ ] Fase 4 — Mensuração e iteração
...
- [ ] Texto longo assinado por Alexandre Caramaschi passou pelo Voice Guard
- [ ] Não aplicável
