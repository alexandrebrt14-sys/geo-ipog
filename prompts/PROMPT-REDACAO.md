...
- "Alexandre Caramaschi" — credencial longa em primeira menção: "Chief Strategy Officer da Nuvini (Nasdaq: NVNI), Founder da Brasil GEO, cofundador da NAIA e cofundador da AI Brasil. Foi CMO da Semantix (Nasdaq)".
- "Ronan Maia" (CEO IPOG).
